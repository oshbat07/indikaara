          ...
          <div className="bg-white/70 backdrop-blur-lg shadow-xl rounded-2xl overflow-hidden border border-white/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="px-8 py-8 space-y-6">
              <div className="group">
                ...
                <p className="text-lg text-gray-900 font-medium group-hover:text-teal-600 transition-colors duration-200">{user.name || 'Not provided'}</p>
              </div>
              ...
              <div className="group">
                ...
                <p className="text-lg text-gray-900 font-medium flex items-center group-hover:text-teal-600 transition-colors duration-200">
                  {user.email}
                  {user.email_verified && (
                    <svg className="ml-3 h-6 w-6 text-teal-500 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
              ...
              {user.given_name && (
                <div className="group">
                  ...
                  <p className="text-lg text-gray-900 font-medium group-hover:text-teal-600 transition-colors duration-200">{user.given_name}</p>
                </div>
              )}
              ...
              {user.family_name && (
                <div className="group">
                  ...
                  <p className="text-lg text-gray-900 font-medium group-hover:text-teal-600 transition-colors duration-200">{user.family_name}</p>
                </div>
              )}
              ...
              {user.locale && (
                <div className="group">
                  ...
                  <p className="text-lg text-gray-900 font-medium group-hover:text-teal-600 transition-colors duration-200">{user.locale.toUpperCase()}</p>
                </div>
              )}
            ...
            <div className="px-8 py-8 space-y-6">
                ...
                <div className="flex items-center group-hover:scale-105 transition-transform duration-200">
                  {user.sub ? (
                    <div className="flex items-center bg-gradient-to-r from-teal-50 to-teal-100 px-4 py-3 rounded-xl border border-teal-200">
                      <svg className="h-6 w-6 text-teal-600 mr-3" viewBox="0 0 24 24">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="group">
                  ...
                  <p className="text-base text-gray-900 font-medium group-hover:text-teal-600 transition-colors duration-200">{formatDate(user.iat)}</p>
                </div>
              ...
              <div className="group">
                ...
                <p className="text-lg text-gray-900 font-medium group-hover:text-teal-600 transition-colors duration-200">{formatDate(user.exp)}</p>
              </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 group-hover:text-teal-700 transition-colors duration-200">Browse Products</h3>
                      <p className="text-sm text-gray-600 group-hover:text-teal-600 transition-colors duration-200">Explore our curated collection of artisan crafts</p>
                    </div>
                  </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-bold text-gray-900 group-hover:text-teal-700 transition-colors duration-200">My Wishlist</h3>
                      <p className="text-sm text-gray-600 group-hover:text-teal-600 transition-colors duration-200">View and manage your saved favorite items</p>
                    </div>
                  </div>
                  <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <svg className="w-6 h-6 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
