  ...
  if (loading && posts.length === 0) {
    return (
      ...
      >
        ...
        <div className="rounded-lg border border-gray-700 bg-[#2a2a2a]/60 p-4 animate-pulse">
          <div className="h-10 w-full md:w-80 rounded-lg bg-gray-700/70 mb-4" />
          <div className="grid grid-cols-4 gap-2 mb-3">
            <div className="h-4 rounded bg-gray-700/65" />
            <div className="h-4 rounded bg-gray-700/65" />
            <div className="h-4 rounded bg-gray-700/65" />
            <div className="h-4 rounded bg-gray-700/65" />
          </div>
          <div className="space-y-3">
            {Array.from({ length: 5 }).map((_, idx) => (
              <div
                key={`admin-post-row-${idx}`}
                className="h-12 rounded bg-gray-700/55"
              />
            ))}
          </div>
        </div>
