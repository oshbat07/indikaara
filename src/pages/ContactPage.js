      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-text-secondary max-w-2xl mx-auto">
            Have questions about our handcrafted products or need assistance? We're here to help connect you with India's finest artisans.
          </p>
        </div>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary text-sm">Mon-Fri: 9 AM - 6 PM IST</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary">
                      Indikaara Handicrafts Pvt Ltd<br />
                      123 Artisan Street, Craft Quarter<br />
            ...
            <div className="bg-gray-800/50 rounded-xl p-8">
              ...
              <p className="text-text-secondary mb-6">
                Stay connected for the latest artisan stories and handcrafted collections.
              </p>
            ...
            <div className="bg-gray-800/50 rounded-xl p-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-text-primary">10:00 AM - 4:00 PM IST</span>
                </div>
                <div className="flex justify-between">
