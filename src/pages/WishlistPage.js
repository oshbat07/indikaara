  ...
  if (loading) {
    return (
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 animate-pulse">
          {Array.from({ length: 8 }).map((_, idx) => (
            <div
              key={`wishlist-skeleton-${idx}`}
              className="bg-gray-800 rounded-xl border border-gray-700 p-3"
            >
              <div className="h-32 sm:h-48 rounded-lg bg-gray-700/70 mb-3" />
              <div className="h-4 w-4/5 rounded bg-gray-700/65 mb-2" />
              <div className="h-3 w-1/2 rounded bg-gray-700/60 mb-3" />
              <div className="h-4 w-2/5 rounded bg-gray-700/65" />
            </div>
          ))}
        </div>
      </main>
        ...
        {wishlistItems.length === 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-text-secondary mb-8 max-w-md mx-auto">
              Start browsing our beautiful collection and save your favorite
          ...
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
              {wishlistItems.map((item) => (
                <div
                  key={item.id}
                  className="bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-gray-700"
                >
                  {/* Product Image */}
